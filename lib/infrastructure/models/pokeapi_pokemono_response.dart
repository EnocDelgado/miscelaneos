...
//
//     final pokeApiPokemonResponse = pokeApiPokemonResponseFromJson(jsonString);

// import 'dart:convert';
// PokeApiPokemonResponse pokeApiPokemonResponseFromJson(String str) => PokeApiPokemonResponse.fromJson(json.decode(str));
// String pokeApiPokemonResponseToJson(PokeApiPokemonResponse data) => json.encode(data.toJson());
